<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminItems.aspx.cs" Inherits="RusticRuchulu.adminItems" %>
...
<body ng-controller="rusticRuchuluController" ng-init="GetItemsByCategory()">
                        ...
                        <nav class="site-navigation text-right" role="navigation">
                            <div class="">
                                ...
                                <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                                    ...
                                    <%--Admin Items--%>
                                    <li ng-if="LoginUserRole == 'Admin'">
                                        <a href="adminItems.aspx" class="nav-link active">
                                            <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
                                    ...
                                    <li ng-if="!IsLogin"><a href="login.aspx" class="nav-link">
                                        <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M2.31641 3.25C1.90219 3.25 1.56641 3.58579 1.56641 4C1.56641 4.41421 1.90219 4.75 2.31641 4.75H3.49696C3.87082 4.75 4.18759 5.02534 4.23965 5.39556L5.49371 14.3133C5.6499 15.424 6.60021 16.25 7.72179 16.25L18.0664 16.25C18.4806 16.25 18.8164 15.9142 18.8164 15.5C18.8164 15.0858 18.4806 14.75 18.0664 14.75L7.72179 14.75C7.34793 14.75 7.03116 14.4747 6.9791 14.1044L6.85901 13.2505H17.7114C18.6969 13.2505 19.5678 12.6091 19.8601 11.668L21.7824 5.48032C21.8531 5.25268 21.8114 5.00499 21.6701 4.81305C21.5287 4.62112 21.3045 4.50781 21.0662 4.50781H5.51677C5.14728 3.75572 4.37455 3.25 3.49696 3.25H2.31641ZM5.84051 6.00781L6.64807 11.7505H17.7114C18.0399 11.7505 18.3302 11.5367 18.4277 11.223L20.0478 6.00781H5.84051Z" fill="#092a8e" />
                                            <path d="M7.78418 17.75C6.81768 17.75 6.03418 18.5335 6.03418 19.5C6.03418 20.4665 6.81768 21.25 7.78418 21.25C8.75068 21.25 9.53428 20.4665 9.53428 19.5C9.53428 18.5335 8.75068 17.75 7.78418 17.75Z" fill="#092a8e" />
                                            <path d="M14.5703 19.5C14.5703 18.5335 15.3538 17.75 16.3203 17.75C17.2868 17.75 18.0704 18.5335 18.0704 19.5C18.0704 20.4665 17.2869 21.25 16.3204 21.25C15.3539 21.25 14.5703 20.4665 14.5703 19.5Z" fill="#092a8e" />
    ...
    <section id="categories" class="section light-bg">
        <div class="container">
            <h2 class="mt_40">Categories</h2>
            <div class="categories-accordion" id="accordionExample">
                <div class="card" ng-repeat="category in categories">
                    <div class="card-header" id="heading{{$index}}" data-toggle="collapse" data-target="#collapse{{$index}}" aria-expanded="false" aria-controls="collapse{{$index}}">
                        <div class="mb-0 h-center">
                            <div>
                                <div class="v-center">
                                    <img class="img-fluid card-header-img" ng-src="{{category.CategoryImage}}" alt="card image" />
                                    <div>
                                        <div class="categories-title">{{category.CategoryName}}</div>
                                        <div class="categories-subtitle">{{category.CategoryDescription}}</div>
                                    </div>
                                </div>
                            </div>
                            <div>
                    ...
                    <div id="collapse{{$index}}" class="collapse show" aria-labelledby="heading{{$index}}" data-parent="#accordionExample">
                        <div class="card-body medium-gray">
                            <div class="row m_0">
                                <div class="col-sm-12 col-lg-12 col-xl-12 card p_0 mb_12">
                                    <div class="new_category_div">
                                        <div id="AddNewItem" class="new_category_btn" ng-click="AddNewItem(category.CategoryID)"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add new Item</div>
                                    </div>
                                </div>
                            </div>
                            <div class="row m_0">
                                <div class="col-sm-12 col-lg-6 col-xl-6 card" ng-repeat="item in category.items">
                                    <div class="row m_0">
                                        <div class="col-sm-12 col-lg-6 col-xl-6">
                                            <div class="categories-item">
                                                <img class="img-fluid" ng-src="{{item.ItemImage}}" alt="card image" />
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6 col-xl-6 pl_0">
                                            <div class="categories-item">
                                                <div class="categories-title">
                                                    <div class="card-title1">{{item.ItemName}}</div>
                                                    <div ng-if="!item.IsEdit">
                                                        <i class="fa fa-pencil pencil-icon" aria-hidden="true" ng-click="EditItemClick(category.CategoryID, item.ItemID)"></i>
                                                    </div>
                                                    <div ng-if="item.IsEdit">
                                                        <i class="fa fa-close pencil-icon" aria-hidden="true" ng-click="resetItemsAllIsEdit()"></i>
                                                    </div>
                                                </div>
                                                <div class="card-desc1">{{item.ItemDescription}}</div>
                                                <div class="card-price-org1"><b>Price:</b> ₹{{item.OriginalPrice}}</div>
                                                <div class="card-price-org1"><b>Discount Percentage:</b> {{item.DiscountPercentage}}</div>
                                                <div class="card-price-org1"><b>Final Price:</b> ₹{{item.OriginalPrice - (item.OriginalPrice * item.DiscountPercentage / 100)}}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row m_0 mb_12" style="background-color: #f2f2f2" ng-if="item.IsEdit">
                                        <div class="col-sm-12 col-lg-12 col-xl-12">
                                            <input class="form-control mt_12" type="file" id="formFile" onchange="angular.element(this).scope().convertToBase64ForItem(this)">
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-xl-12">
                                            <div class="form-control">
                                                <input type="text" ng-model="item.ItemName" name="ItemName" class="form-input" placeholder="none" required ng-change="">
                                                <label for="ItemName" class="form-label">Item Name<span>*</span></label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                            <div class="form-control">
                                                <input type="text" ng-model="item.ItemDescription" name="ItemDescription" class="form-input" placeholder="none" required>
                                                <label for="ItemDescription" class="form-label">Item Description<span>*</span></label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-4 col-xl-4">
                                            <div class="form-control">
                                                <input type="text" ng-model="item.OriginalPrice" name="OriginalPrice" class="form-input" placeholder="none" required>
                                                <label for="OriginalPrice" class="form-label">Item Price<span>*</span></label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-4 col-xl-4">
                                            <div class="form-control">
                                                <input type="text" ng-model="item.DiscountPercentage" name="DiscountPercentage" class="form-input" placeholder="none" required>
                                                <label for="DiscountPercentage" class="form-label">Discount %<span>*</span></label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-4 col-xl-4">
                                            <div class="form-control">
                                                <input type="text" ng-model="item.OriginalPrice - (item.OriginalPrice * item.DiscountPercentage / 100)" name="FinalPrice" disabled class="form-input" placeholder="none" required>
                                                <label for="FinalPrice" class="form-label">Final Price</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12 col-xl-12 mb_12">
                                            <button class="default-primary-btn" ng-click="UpsertItem(category.CategoryID, item.ItemID)">Update Item</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <%--<div class="row" ng-if="category.items.length" id="BestSellers">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" ng-repeat="item in category.items">
                                    <div class="">
                                            ...
                                            <div class="frontside">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <h4 class="card-desc">{{item.ItemDescription}}</h4>
                                                        <div class="card-price">
                                                            <div class="card-price-org">₹{{item.Price}}</div>
                                                            <div class="card-price-dis">₹200</div>
                                                            <div class="card-price-dis-per">{{item.DiscountPercentage}}% off</div>
                                                        </div>
                                                        <div class="card-cart">
                                                            <div class="card-cart-add" ng-if="item.CartCount === 0" ng-click="AddToCart(category.CategoryID,item.ItemID)">
                                                                Add To Cart <i class="fa fa-cart-plus ml_10" aria-hidden="true"></i>
                                                            </div>
                                                            <div class="card-cart-add-outline" ng-if="item.CartCount !== 0" ng-click="AddToCart(category.CategoryID,item.ItemID)">
                                                                <i class="fa fa-check-circle" aria-hidden="true"></i>Item Added To Cart 
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <p ng-if="!category.items.length">{{category.description}}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <%--
        ...
        document.getElementById("loginBtn").addEventListener("click", function () {
            document.getElementById("loginSidebar").style.right = "0";
        });

        document.getElementById("closeSidebar").addEventListener("click", function () {
            document.getElementById("loginSidebar").style.right = "-100%";
        });
    </script>
    --%>
