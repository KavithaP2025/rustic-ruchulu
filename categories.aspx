<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="RusticRuchulu.categories" %>
...
<body ng-controller="rusticRuchuluController" ng-init="GetItemsByCategory()">
                            ...
                            <div class="">
                                ...
                                <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                                    ...
                                    <li ng-if="LoginUserRole == 'User'">
                                        <a href="categories.aspx" class="nav-link active">
                                            <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
                    ...
                    <div id="collapse{{$index}}" class="collapse" aria-labelledby="heading{{$index}}" data-parent="#accordionExample">
                        <div class="card-body">
                            <div class="row" ng-if="category.items.length" id="BestSellers">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3" ng-repeat="item in category.items">
                                    <div class="">
                                            ...
                                            <div class="frontside">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <%--<div class="card-qty-tags">
                                                            <div class="card-qty-tag" ng-repeat="tag in item.QuantityTags">{{tag.TagName}}</div>
                                                        </div>--%>
                                                        ...
                                                        <div class="card-cart">
                                                            <div class="card-cart-add" ng-if="item.CartCount === 0" ng-click="AddToCart(category.CategoryID,item.ItemID, 'Add', 1, 0)">
                                                                Add To Cart <i class="fa fa-cart-plus ml_10" aria-hidden="true"></i>
                                                            </div>
                                                            <div class="card-cart-add-outline" ng-if="item.CartCount !== 0" ">
                                                                Item Added To Cart <i class="fa fa-check-circle ml_10" aria-hidden="true"></i>  
                                                            </div>
                                                        </div>
                                                        <%--<div ng-if="item.CartCount !== 0" class="card-cart">
                                                            <div class="card-cart-count">
                                                                <div class="card-cart-count-child" ng-click="DecreaseFromCart(category.CategoryID,item.ItemID)"><i class="fa fa-minus"></i></div>
                                                                <div class="card-cart-count-child1">{{item.CartCount}}</div>
                                                                <div class="card-cart-count-child" ng-click="IncreaseFromCart(category.CategoryID,item.ItemID)"><i class="fa fa-plus"></i></div>
                                                            </div>
                                                        </div>--%>
                                                    </div>
                                                </div>
    ...
    <!-- Modal -->
    <div class="modal fade otp_modal" id="loginModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text2">Please log in to our application to place an order.</h4>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn default-sceondary-btn" data-dismiss="modal">Close</button>
                    <button type="button" class="btn default-primary-btn" ng-click="redirectToLogin()">Login</button>
                    <button type="button" class="btn default-primary-btn" ng-click="redirectToRegister()">Register</button>
                </div>
            </div>
        </div>
    </div>
