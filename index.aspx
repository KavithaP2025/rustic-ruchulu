<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="RusticRuchulu.index" %>
                        ...
                        <nav class="site-navigation text-right" role="navigation">
                            <div class="">
                                ...
                                <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                                    <li><a href="index.aspx" class="nav-link active">
    ...
    <div class="scrolling-box">
        ...
        <section class="slider">
            <div class="hero-slider">
                <div class="single-slider" style="background-image: url('./img/spices.png')">
                    <div class="c11">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text">
                                    <h1>Train Your Body To Crave Healthy Food</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="single-slider" style="background-image: url('./img/spices2.png')">
                    <div class="c11">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text">
                                    <h1><span>A Classic Range of </span>
                                        <br />
                                        Spices
                                        <br />
                                        <span>Await You !</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="single-slider" style="background-image: url('./img/spices3.png')">
                    <div class="c11">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                            <h2>Bestsellers</h2>
                            <img src="img/heading-img_1.png" alt="#">
                            ...
                            <div class="mainflip flip-0">
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="text-center">
                                                <img class=" img-fluid" src="./img/pista.jpg" alt="card image">
                                            </p>
                                            <h4 class="card-title">Pista</h4>
                                            <h4 class="card-desc">Pista description Pista description</h4>
                                            <div class="card-price">
                                                <div class="card-price-org">₹150</div>
                                                <div class="card-price-dis">₹200</div>
                                                <div class="card-price-dis-per">10% off</div>
                                            </div>
                                            <div class="card-cart">
                                                <div class="card-cart-add">Add <i class="fa fa-plus"></i></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mainflip flip-0">
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="text-center">
                                                <img class=" img-fluid" src="./img/almond.jpg" alt="card image">
                                            </p>
                            ...
                            <div class="mainflip flip-0">
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="text-center">
                                                <img class=" img-fluid" src="./img/cashew.jpg" alt="card image">
                                            </p>
                            ...
                            <div class="mainflip flip-0">
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="text-center">
                                                <img class=" img-fluid" src="./img/raisins.jpg" alt="card image">
                                            </p>
                                            <h4 class="card-title">Raisins</h4>
                                            <h4 class="card-desc">Pista description Pista description</h4>
                                            <div class="card-price">
                                                <div class="card-price-org">₹150</div>
                                                <div class="card-price-dis">₹200</div>
                            ...
                            <div class="mainflip flip-0">
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="text-center">
                                                <img class=" img-fluid" src="./img/w1.jpg" alt="card image">
                                            </p>
        ...
        <!-- Start Categories -->
        <section class="pricing-table section categories-home" id="Categories">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                                ...
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            ...
                                            <h4 class="card-title">Veg Pickles</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            ...
                                            <h4 class="card-title">Non Veg Pickles</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            ...
                                            <h4 class="card-title">Dry sea food</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            ...
                                            <h4 class="card-title">Dry Fish</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="call-action overlay" id="contact" data-stellar-background-ratio="0.5">
            <div class="">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="content">
                            ...
                            <p>
                                Rustic Ruchulu -
								 "Explore Our Premium Selection of Nuts, Honey, Spices, and More."
						
                            </p>
                            <p>
                                <a href="#"><i class="fa fa-map-marker"></i>&nbsp; Kondapur, Hyderbad, 500084</a>
                            </p>
                            <p><a href="#"><i class="fa fa-phone"></i>&nbsp; +91 000000000</a></p>
                            <p><a href="#"><i class="fa fa-phone"></i>&nbsp; +91 0000000000</a></p>
                            <p>
                                <a href="#"><i class="fa fa-solid fa-envelope"></i>&nbsp; rusticruchulu@gmail.com</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="owl-carousel clients-slider">
                            ...
                            <div class="single-clients">
                                <img src="img/cashew.jpg" alt="#">
                            </div>
                            <div class="single-clients">
                                <img src="img/raisins.jpg" alt="#">
                            </div>
                            <div class="single-clients">
                                <img src="img/pista.jpg" alt="#">
                            </div>
