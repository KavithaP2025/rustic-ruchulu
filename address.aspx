<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="address.aspx.cs" Inherits="RusticRuchulu.address" %>
...
<body ng-controller="rusticRuchuluController" ng-init="GetUserAddress()">
    ...
    <div class="site-navbar-wrap">
        ...
        Login
                                    ...
                                    <li ng-if="IsLogin" class="dropdown active">
    ...
    <div class="address">
        <div class="login_body mt_100">
            <div class="row m-0">
                <div class="col-sm-12 col-md-12 col-xl-12">
                    <div class="new_address_div">
                        <div class="new_address_btn" id="AddNewAddress"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add A new address</div>
                        <form class="new-address-form" id="createAddressDiv" style="display: none">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-control">
                                        <input type="text" ng-model="AddressUserName" name="AddressUserName" class="form-input" placeholder="none" required>
                                        <label for="AddressUserName" class="form-label">Name<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-control">
                                        <input type="text" ng-model="AddressPhoneNumber" name="AddressPhoneNumber" class="form-input" placeholder="none" required>
                                        <label for="AddressPhoneNumber" class="form-label">Phone No.<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-control">
                                        <input type="text" ng-model="Pincode" name="Pincode" class="form-input" placeholder="none" required>
                                        <label for="Pincode" class="form-label">Pincode<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-control">
                                        <input type="text" ng-model="Locality" name="Locality" class="form-input" placeholder="none" required>
                                        <label for="Locality" class="form-label">Locality<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    <div class="form-control">
                                        <input type="text" ng-model="Address" name="Address" class="form-input" placeholder="none" required>
                                        <label for="Address" class="form-label">Address<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-control">
                                        <input type="text" ng-model="City" name="City" class="form-input" placeholder="none" required>
                                        <label for="City" class="form-label">City/Town<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-xl-6">
                                    <div class="form-control">
                                        <input type="text" ng-model="State" name="State" class="form-input" placeholder="none" required>
                                        <label for="State" class="form-label">State<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    <button class="default-primary-btn" ng-click="UpsertUserAddress()">Save Address</button>
                                    &nbsp;&nbsp;&nbsp;
                                    <button class="default-sceondary-btn" ng-click="ResetAddress()">Cancel</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row m-0">
                <div class="col-sm-12 col-md-12 col-xl-12 mt-3" ng-repeat="address in addressList">
                    <div class="address_card" id="address-{{$index}}">
                        <div class="address_card1">
                            <div><span class="address_title">{{address.AddressUserName}} - {{address.AddressPhoneNumber}}</span></div>
                            <div><i class="fa fa-pencil pencil-icon" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; <i class="fa fa-trash delete-icon" ng-click="SelectedUserAddress(address.AddressID)"></i></div>
                        </div>
                        <div class="address_card2 mt-2">
                            <div>{{address.Locality}}, {{address.Address}}, {{address.City}}, {{address.State}} - <span class="address_title">{{address.Pincode}}</span></div>
                        </div>
                    </div>
                </div>
            </div>
