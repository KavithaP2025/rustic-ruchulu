<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="RusticRuchulu.login" %>
...
<body ng-controller="rusticRuchuluController">
        ...
        <div class="login_body row">
            <div class="login_body1 col-sm-12 col-md-6 col-xl-6">
                <div>
                    ...
                    <button class="btn register_btn" onclick="redirectToRegisterPage()">Register</button>
                </div>
                ...
                <div>
                    <form class="contact-inform form">
                        <div class="form-control">
                            ...
                            <p ng-if="IsEmailError">Please enter email.</p>
                            <label for="email" class="form-label">Email<span>*</span></label>
                        </div>
                        <button class="btn OTP_btn" ng-click="RequestOTP()">Request OTP</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 class="text1">An otp has been sent to ******6384@gmail.com</h5>
                    <h4 class="text2">Please enter OTP to verify</h4>

                    <div id="otp-container">
                        <input type="text" ng-model="otpText1" maxlength="1" class="otp-input" />
                        <input type="text" ng-model="otpText2" maxlength="1" class="otp-input" />
                        <input type="text" ng-model="otpText3" maxlength="1" class="otp-input" />
                        <input type="text" ng-model="otpText4" maxlength="1" class="otp-input" />
                        <input type="text" ng-model="otpText5" maxlength="1" class="otp-input" />
                        <input type="text" ng-model="otpText6" maxlength="1" class="otp-input" />
                    </div>
                    <p class="error-message mt_12" ng-if="IsOTPInputError">Please enter valid OTP.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn default-sceondary-btn" data-dismiss="modal">Close</button>
                    <button type="button" class="btn default-primary-btn" ng-click="ValidateEmailAndPin()">Verify</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        function redirectToRegisterPage() {
            window.location.href = "/register.aspx"; // Replace with your desired URL
        }
