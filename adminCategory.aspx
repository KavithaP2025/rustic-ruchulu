<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminCategory.aspx.cs" Inherits="RusticRuchulu.adminCategory" %>
...
<body ng-controller="rusticRuchuluController" ng-init="GetCategories()">
                            ...
                            <div class="">
                                ...
                                <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                                    ...
                                    <li ng-if="LoginUserRole == 'Admin'">
                                        <a href="adminCategory.aspx" class="nav-link active">
                                            <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
    ...
    <section id="categories" class="section light-bg">
        <div class="container mt_40">
            <div class="row m_0">
                <div class="col-sm-12 col-lg-12 col-xl-12 card p_0 mb_12">
                    <div class="new_category_div">
                        <div id="AddNewCategory" class="new_category_btn"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add new category</div>
                        <form class="new-address-form" id="createDivCategory" style="display: none">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    <input class="form-control mt_12" type="file" id="formFile" onchange="angular.element(this).scope().convertToBase64ForCatogory(this)">
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    <div class="form-control">
                                        <input type="text" ng-model="AdminCategoryName" name="AdminCategoryName" class="form-input" placeholder="none" required>
                                        <label for="AdminCategoryName" class="form-label">Category Name<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    <div class="form-control">
                                        <input type="text" ng-model="AdminCategoryDescription" name="AdminCategoryDescription" class="form-input" placeholder="none" required>
                                        <label for="AdminCategoryDescription" class="form-label">Category Description<span>*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    <button class="default-primary-btn" ng-click="UpsertCategory()">Save Category</button>
                                    &nbsp;&nbsp;&nbsp;
                                <button class="default-sceondary-btn" ng-click="ResetCategory()">Cancel</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row m_0">
                <div class="col-sm-12 col-lg-4 col-xl-4 card" ng-repeat="category in CategoriesList">
                    <div class="row m_0">
                        ...
                        <div class="col-sm-12 col-lg-6 col-xl-6 pl_0">
                            <div class="categories-item">
                                <div class="categories-title">
                                    ...
                                    <div ng-if="!category.IsEdit">
                                        <i class="fa fa-pencil pencil-icon" aria-hidden="true" ng-click="EditCategory($index, category.CategoryID)"></i>
                                    </div>
                                    <div ng-if="category.IsEdit">
                                        <i class="fa fa-close pencil-icon" aria-hidden="true" ng-click="ResetCategory($index)"></i>
                                    </div>
                                </div>
                    ...
                    <div class="row m_0 mb_12" style="background-color: #f2f2f2" ng-if="category.IsEdit">
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <input class="form-control mt_12" type="file" id="formFile" onchange="angular.element(this).scope().convertToBase64(this)">
                        </div>
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="form-control">
                                <input type="text" ng-model="category.CategoryName" name="AdminCategoryName" class="form-input" placeholder="none" required ng-change="">
                                <label for="AdminCategoryName" class="form-label">Category Name<span>*</span></label>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-xl-12">
                            <div class="form-control">
                                <input type="text" ng-model="category.CategoryDescription" name="AdminCategoryDescription" class="form-input" placeholder="none" required>
                                <label for="AdminCategoryDescription" class="form-label">Category Description<span>*</span></label>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-xl-12 mb_12">
                            <button class="default-primary-btn" ng-click="UpsertCategory()">Update Category</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Modal -->
    <div class="modal fade otp_modal" id="deleteAddressModel" tabindex="-1" role="dialog" aria-labelledby="deleteAddressModelTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <h4 class="text3 mt-3">Are you sure you want to delete this address?</h4>
                    <div class="confirmation_buttons mt-4 mb-3">
                        <button type="button" class="btn default-primary-btn" ng-click="DeleteUserAddress()">Yes, Delete</button>
                        <button type="button" class="btn default-sceondary-btn" data-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
